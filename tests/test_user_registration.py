...
class TestUserRegistrtation:
    
    #Регистрация пользователя
    def test_user_registration_valid_email_sucess(self, browser):
        # Нажать кнопку «Вход и регистрация».
        browser.find_element(*locator.enter_and_register_button).click()
        
        # Нажать кнопку «Нет аккаунта».
        WebDriverWait(browser, 3).until(EC.element_to_be_clickable(locator.ent_no_account_button))
    ...
    def test_user_registration_invalid_email_error(self, browser):
        browser.find_element(*locator.enter_and_register_button).click()
    ...
    def test_user_registration_user_exist_error(self, browser):
        # Нажать кнопку «Вход и регистрация».
        browser.find_element(*locator.enter_and_register_button).click()
